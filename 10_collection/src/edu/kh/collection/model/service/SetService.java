...
public class SetService {
	...
	public void ex1() {
		...
		// Set.iterator();
		// Set에 저장된 객체를 이용해서 iterator 객체를 만들어 변환
...
//			lotto.add(new Integer(ran)); // deprecated(삭제 예정) 
			lotto.add(ran); // 중복값이 나오면 알아서 안들어가짐(set)
		}
