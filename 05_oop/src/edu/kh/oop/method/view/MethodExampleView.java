...
// 콘솔에 보여지는 내용 출력, 입력 받는 용도
public class MethodExampleView {

	// 클래스 내 어디서든 사용 가능한 Scanner 객체 생성
	// (캡슐화 원칙에 따라서 private)
	private Scanner sc = new Scanner(System.in); // 지역변수로 매번 쓰지 않게 field로 올림
	...
	public void displayMenu() {
		...
		do {
			...
			case 2 : // service.method2(50, 76, 88);
					// this.menu2();
	...
	public void menu2() { 
		// 매개변수x, 반환형x인 메서드를 하나 더 만들어서 호출->호출
