...
public class Member {
	...
	private String memberPhone;
			// 전화번호는 string, int로 하면 맨 앞의 0이 사라짐
	...
	public Member(String memberId, String memberPw, String memberPhone, int memberAge) {
					// -> 매개 변수(Parameter)
					// * 매개 : 둘 사이에 관계 형성(전달 받는 역할, 값을 얻어옴)
	...
	// ** 오버로딩 주의사항**
	// -> 매개변수의 '자료형'의 타입, 개수, 순서 중 하나라도 달라야 한다!
	// --> 매개변수명은 사용자가 보기 편하게하기 위해 의미를 부여하는 것 뿐
	//     컴퓨터에게는 불필요한 요소라서 오버로딩 검사시 인식되지 않음
