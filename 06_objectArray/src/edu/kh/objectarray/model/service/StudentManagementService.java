...
public class StudentManagementService {
	 ...
	 *   0 : stdArr[idx] 인덱스라 null인 경우(참조X)
	 *   1 : 정상적으로 수정이 된 경우
	 */
	...
	public Student[] selectName(String name) {
		...
		// 메서드 종료 시 반환
		// return 값은 한 번에 여러값 반환이 안되서 배열을 새로 만드는 것
