...
public class ForExample {
	 ...
	 *     		보통 초기식에 사용된 변수를 증가/감소 시켜 조건식의 결과를 변화게 만듦.
	 */
	...
	public void ex3() {
		...
		// 두 정수를 입력 받아 
		// 두 정수 사이의 모든 정수 합을 출력(num1부터 num2까지)
	...
	public void ex4() {
		 ...
		 * 10.0 + 0.5 (자동 형변환)
		 * 10.5 (double)
		 * but 다시 초기식으로 돌아가면서 int로 강제 형변환을 시켜주기때문에
		 * 10.5 (double) -> 10 (int) 가 되어 10이 무한 출력된다
		 */
	...
	public void ex18() {
		...
		for(int row=1; row <= 3; row++) {
			...
			for(int col=1; col <= 4; col++) { 
				//이전까지는 col을 출력해서 한 줄마다 초기화 됐지만 count는 for문 이전에 초기화 되어서 영향 받지X
				
				System.out.printf("%3d", count++);
				// 후위 증감 연산을 이용하여 출력 후 count 값을 1 증가
			}
			System.out.println();
		}
