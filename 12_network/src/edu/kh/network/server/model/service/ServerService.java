...
public class ServerService {
	 ...
	 * - 하나믜 포트에는 하나의 ServerSocket만 연결 가능
	 */
...
//			6. 보조 스트림을 통해 성능 개선
			...
			// is는 byte기반, br는 문자기반이어서 is를 바로 쓰면 안됨
			// 문자 기반 BufferedReader와
			// 바이트 기반인 InputStream을 연결할 수 있도록
...
//			7. 스트림을 통해 읽고 쓰기
			...
			Date now = new Date(); // java.util.Date : 자바에서 시간을 나타내는 객체
							       // new Date()로 객체 생성 시 현재 시간이 지정되어 있다.
