...
//		String serverIP = "192.168.10.78";  // loop back IP(현재 컴퓨터를 나타내는 IP)
		int port = 8500;
		...
		try {
			...
			// UnknownHostException : IP가 잘못 되었을 때(가게 주인을 알 수 없음)
			// 소캣을 만들어서 가지고 port로 간다
